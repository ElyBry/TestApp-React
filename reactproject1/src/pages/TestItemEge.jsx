            ...
            <div className="main">
                ...
                <div className="sc_block_it">
                    <div className="btnsitem">
                        <Link to="/ege/TestQuest?subject=Русский язык&id=1" className="btn">Русский язык</Link>
                        <Link to="/ege/TestQuest?subject=Обществознание&id=1" className="btn">Обществознание</Link>
                        <Link to="/ege/TestQuest?subject=Математика&id=1" className="btn">Математика</Link>
                        <Link to="/ege/TestQuest?subject=Информатика&id=1" className="btn">Информатика</Link>
                        <Link to="/ege/TestQuest?subject=Английский язык&id=1" className="btn">Английский язык</Link>
                    </div>
                </div>
            </div>
        </>

            ...
            <div className="main">
                ...
                <div className="sc_block_it">
                    <div className="btnsitem">
                        <Link to="/oge/TestQuest?subject=Русский язык&id=1" className="btn">Русский язык</Link>
                        <Link to="/oge/TestQuest?subject=Обществознание&id=1" className="btn">Обществознание</Link>
                        <Link to="/oge/TestQuest?subject=Математика&id=1" className="btn">Математика</Link>
                        <Link to="/oge/TestQuest?subject=Информатика&id=1" className="btn">Информатика</Link>
                        <Link to="/oge/TestQuest?subject=Английский язык&id=1" className="btn">Английский язык</Link>
                    </div>
                </div>
            </div>
        </>
